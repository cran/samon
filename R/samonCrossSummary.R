...
# --------------------------------------------------------------------------------
samonCrossSummary <- function(trt1,trt2, CIlevel=0.95) {
  ...
  colnames(TM1) <- c("alpha1","IFEst1","IFVar1","meanjk1","sejk1","meanBoot1","seBoot1")
  colnames(TM2) <- c("alpha2","IFEst2","IFVar2","meanjk2","sejk2","meanBoot2","seBoot2")
  colnames(TS1) <- c("alpha1","Sample","IFEst1","IFVar1","meanjk1","sejk1","MIFEst1")
  colnames(TS2) <- c("alpha2","Sample","IFEst2","IFVar2","meanjk2","sejk2","MIFEst2")
  ...
  cicut2 <- 1 - cicut1
    ...
    CI <- cbind( alpha1, alpha2,Difference,lb1, ub1, lb2, ub2, lb3, ub3, lb4, ub4, lb5, ub5, lb6, ub6, lb7, ub7, lb8, ub8)
