...
samonPlot(Results1, "Plots/Results1.pdf",  5.5, 6, "Estimate",    c(-10,10), c(  0.55,  0.85 ), c( 3.6,  0.85 ), maintext = NULL )
samonPlot(Results2, "Plots/Results2.pdf",  5.5, 6, "Estimate",    c(-10,10), c(  0.55,  0.85 ), c( 3.6,  0.85 ), maintext = NULL )
samonPlot(ResultsD, "Plots/ResultsD.pdf",  5.5, 6, "Difference",  c(-10,10), c(  0.0,   0.15 ), c( 3.6, -0.05), maintext = NULL )
